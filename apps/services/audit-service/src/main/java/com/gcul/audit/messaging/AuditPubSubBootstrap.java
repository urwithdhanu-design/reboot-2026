...
@Component
public class AuditPubSubBootstrap implements ApplicationRunner, AutoCloseable {
	...
	public AuditPubSubBootstrap(GculPubSubProperties properties, AuditEventHandler handler) {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		String subId = PubSubNames.subscriptionId(
				properties.getTopicPrefix(), EventTopics.AUDIT, properties.getServiceId());

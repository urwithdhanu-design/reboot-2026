...
function buildApiProxy(s: Record<string, string>, admin = false): Record<string, ProxyOptions> {
  ...
  const map: Record<string, ProxyOptions> = {
    ...
    '/api/admin/wallet-ops': proxyEntry(walletTarget),
    '/api/admin/wallet-ops/': proxyEntry(walletTarget),
    '/api/admin/tokenization': proxyEntry(policyTarget),
    '/api/admin/tokenization/': proxyEntry(policyTarget),
    '/api/admin/products': proxyEntry(policyTarget),
    '/api/admin/policy-stats': proxyEntry(policyTarget),
    '/api/admin/audit': proxyEntry(s.audit || 'http://127.0.0.1:8092'),
    '/api/admin/audit/': proxyEntry(s.audit || 'http://127.0.0.1:8092'),
    '/api/admin/observability': proxyEntry(s.observability || 'http://127.0.0.1:8093'),
    '/api/admin/observability/': proxyEntry(s.observability || 'http://127.0.0.1:8093'),
    '/api/internal/policies': proxyEntry(policyTarget),

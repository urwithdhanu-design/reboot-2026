...
export function ClaimsPage() {
  ...
  >([]);
  const [policyRef, setPolicyRef] = useState("POL-HOME-001");
  ...
  async function startClaim() {
    ...
    try {
      const claim = await api.createClaim({
        policy_ref: policyRef.trim() || "POL-HOME-001",
  ...
  return (
    <div className="screen has-nav">
      ...
      <p className="muted">
        Start or track a claim. Backed by the claims microservice on port 8085.
      </p>
